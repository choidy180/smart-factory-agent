...
interface IconBaseProps extends AppIconProps {
  children: ReactNode;
}

function IconBase({ size = 20, strokeWidth = 1.8, children, ...props }: IconBaseProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FactoryIcon(props: AppIconProps) {
  return (
    <IconBase {...props}>
...
export function RootCauseIcon(props: AppIconProps) {
  return (
    <IconBase {...props}>
...
export function ImprovementIcon(props: AppIconProps) {
  return (
    <IconBase {...props}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
...
export function ShieldIcon(props: AppIconProps) {
  return (
    <IconBase {...props}>
